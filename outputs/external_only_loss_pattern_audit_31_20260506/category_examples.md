...
- `openai_gsm8k_17`: no PAL code block emitted despite PAL seed running (PAL=1, gold=4)
- `openai_gsm8k_22`: no PAL code block emitted despite PAL seed running (PAL=1, gold=291)
...
- `openai_gsm8k_184`: gold absent from PAL candidate pool while external found correct target path (PAL=527.6381909547739, gold=525)
...
- `openai_gsm8k_468`: Gold-equivalent candidate existed in PAL pool but selector chose a different final answer. (PAL=30, gold=31)
- `openai_gsm8k_550`: Gold-equivalent candidate existed in PAL pool but selector chose a different final answer. (PAL=5400, gold=1800)
