...
- budget=4: selected=reasoning_beam2, selected_eval_acc=0.250, selected_eval_avg_actions=3.50, oracle_eval_acc=1.000
- budget=6: selected=reasoning_beam2, selected_eval_acc=0.750, selected_eval_avg_actions=4.00, oracle_eval_acc=1.000
- budget=8: selected=reasoning_greedy, selected_eval_acc=0.750, selected_eval_avg_actions=1.25, oracle_eval_acc=1.000

## Frontier gap signal
- Mean oracle-minus-selected accuracy gap across budgets: 0.417
