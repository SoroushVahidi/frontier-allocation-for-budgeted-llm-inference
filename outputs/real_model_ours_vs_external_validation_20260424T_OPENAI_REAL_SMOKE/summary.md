...
- openai: attempted=True completed=True partial=False shards=6/6 reason=

## Ours vs external headline (OpenAI)
- Did best ours beat best external overall? NO
- Best ours method: strict_f3 (0.5333)
- Best external method: self_consistency_3 (0.5667)
- Ours minus external gap: -0.0333
- Evaluated rows: 120
- API/runtime error rows: 0
- Claim safety status: not safe

## Slice support (dataset-budget)
- HuggingFaceH4/MATH-500 @ budget 4: gap=+0.0000
- HuggingFaceH4/MATH-500 @ budget 8: gap=+0.0000
- HuggingFaceH4/aime_2024 @ budget 4: gap=+0.0000
- HuggingFaceH4/aime_2024 @ budget 8: gap=-0.2000
- openai/gsm8k @ budget 4: gap=+0.0000
- openai/gsm8k @ budget 8: gap=+0.0000

## Failure decomposition
- Best ours (strict_f3): absent_from_tree=14, present_not_selected=0, output_layer_mismatch=0
- Best external (self_consistency_3): absent_from_tree=13, present_not_selected=0, output_layer_mismatch=0
