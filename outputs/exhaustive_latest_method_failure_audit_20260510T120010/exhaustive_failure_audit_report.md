...
For the latest method variants (including `production_equiv_v1`, `structural_commit_v1`, `direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal`):
- **FULL**: 215
- **PARTIAL**: 467
- **ID_ONLY**: 445
...
`outputs/exhaustive_latest_method_failure_audit_20260510T120010/`
