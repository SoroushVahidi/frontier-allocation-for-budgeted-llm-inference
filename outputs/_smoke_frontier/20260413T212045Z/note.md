...
- budget=6: selected=reasoning_greedy, selected_eval_acc=0.000, selected_eval_avg_actions=1.00, oracle_eval_acc=1.000

## Frontier gap signal
- Mean oracle-minus-selected accuracy gap across budgets: 1.000
