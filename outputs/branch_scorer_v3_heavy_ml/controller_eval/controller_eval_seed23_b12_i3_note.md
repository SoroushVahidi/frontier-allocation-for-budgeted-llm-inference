...
## Accuracy by method
- adaptive_score_plus_progress: accuracy=0.5376
- adaptive_relative_rank: accuracy=0.5460
- adaptive_learned_branch_score: accuracy=0.5392
- adaptive_learned_branch_score_v4: accuracy=0.5612
- adaptive_learned_branch_score_v5: accuracy=0.5384
- adaptive_learned_branch_score_v6: accuracy=0.5548

- v4 margin over adaptive_relative_rank: 0.0152
- v4 beats adaptive_relative_rank: yes
- v5 margin over adaptive_relative_rank: -0.0076
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: -0.0228
...
- v6 margin over adaptive_learned_branch_score_v5: 0.0164
