...
## Accuracy by method
- adaptive_score_plus_progress: accuracy=0.5112
- adaptive_relative_rank: accuracy=0.5364
- adaptive_learned_branch_score: accuracy=0.5384
- adaptive_learned_branch_score_v4: accuracy=0.5232
- adaptive_learned_branch_score_v5: accuracy=0.5248
- adaptive_learned_branch_score_v6: accuracy=0.5288

- v4 margin over adaptive_relative_rank: -0.0132
- v4 beats adaptive_relative_rank: no
- v5 margin over adaptive_relative_rank: -0.0116
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: 0.0016
