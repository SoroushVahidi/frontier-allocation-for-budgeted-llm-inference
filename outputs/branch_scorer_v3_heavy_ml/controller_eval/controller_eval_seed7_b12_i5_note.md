...
## Accuracy by method
- adaptive_score_plus_progress: accuracy=0.6004
- adaptive_relative_rank: accuracy=0.5916
- adaptive_learned_branch_score: accuracy=0.5764
- adaptive_learned_branch_score_v4: accuracy=0.5980
- adaptive_learned_branch_score_v5: accuracy=0.5736
- adaptive_learned_branch_score_v6: accuracy=0.5844

- v4 margin over adaptive_relative_rank: 0.0064
- v4 beats adaptive_relative_rank: yes
- v5 margin over adaptive_relative_rank: -0.0180
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: -0.0244
- v5 beats adaptive_learned_branch_score_v4: no
- v6 margin over adaptive_relative_rank: -0.0072
