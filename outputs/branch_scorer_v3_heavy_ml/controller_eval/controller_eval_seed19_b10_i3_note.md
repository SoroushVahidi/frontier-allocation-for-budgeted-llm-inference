...
## Accuracy by method
- adaptive_score_plus_progress: accuracy=0.5428
- adaptive_relative_rank: accuracy=0.5336
- adaptive_learned_branch_score: accuracy=0.5500
- adaptive_learned_branch_score_v4: accuracy=0.5344
- adaptive_learned_branch_score_v5: accuracy=0.5240
- adaptive_learned_branch_score_v6: accuracy=0.5380

- v4 margin over adaptive_relative_rank: 0.0008
- v4 beats adaptive_relative_rank: yes
- v5 margin over adaptive_relative_rank: -0.0096
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: -0.0104
- v5 beats adaptive_learned_branch_score_v4: no
- v6 margin over adaptive_relative_rank: 0.0044
