...
- adaptive_relative_rank: accuracy=0.5960
- adaptive_learned_branch_score: accuracy=0.5800
- adaptive_learned_branch_score_v4: accuracy=0.5904
- adaptive_learned_branch_score_v5: accuracy=0.5648
...
- v5 margin over adaptive_relative_rank: -0.0312
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: -0.0256
- v5 beats adaptive_learned_branch_score_v4: no
- v6 margin over adaptive_relative_rank: -0.0212
- v6 beats adaptive_relative_rank: no
- v6 margin over adaptive_learned_branch_score_v5: 0.0100
