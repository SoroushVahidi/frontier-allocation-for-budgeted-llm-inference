...
## Accuracy by method
- adaptive_score_plus_progress: accuracy=0.5384
- adaptive_relative_rank: accuracy=0.5380
- adaptive_learned_branch_score: accuracy=0.5404
- adaptive_learned_branch_score_v4: accuracy=0.5320
- adaptive_learned_branch_score_v5: accuracy=0.5176
- adaptive_learned_branch_score_v6: accuracy=0.5328

- v4 margin over adaptive_relative_rank: -0.0060
- v4 beats adaptive_relative_rank: no
- v5 margin over adaptive_relative_rank: -0.0204
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: -0.0144
- v5 beats adaptive_learned_branch_score_v4: no
- v6 margin over adaptive_relative_rank: -0.0052
