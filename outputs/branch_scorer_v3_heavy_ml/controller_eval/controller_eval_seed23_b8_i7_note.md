...
## Accuracy by method
- adaptive_score_plus_progress: accuracy=0.6148
- adaptive_relative_rank: accuracy=0.6156
- adaptive_learned_branch_score: accuracy=0.6088
- adaptive_learned_branch_score_v4: accuracy=0.6000
- adaptive_learned_branch_score_v5: accuracy=0.5888
- adaptive_learned_branch_score_v6: accuracy=0.6040

- v4 margin over adaptive_relative_rank: -0.0156
- v4 beats adaptive_relative_rank: no
- v5 margin over adaptive_relative_rank: -0.0268
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: -0.0112
- v5 beats adaptive_learned_branch_score_v4: no
- v6 margin over adaptive_relative_rank: -0.0116
