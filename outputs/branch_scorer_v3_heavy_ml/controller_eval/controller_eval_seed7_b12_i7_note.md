...
## Accuracy by method
- adaptive_score_plus_progress: accuracy=0.5972
- adaptive_relative_rank: accuracy=0.6044
- adaptive_learned_branch_score: accuracy=0.6280
- adaptive_learned_branch_score_v4: accuracy=0.6004
- adaptive_learned_branch_score_v5: accuracy=0.6036
- adaptive_learned_branch_score_v6: accuracy=0.6200

- v4 margin over adaptive_relative_rank: -0.0040
- v4 beats adaptive_relative_rank: no
- v5 margin over adaptive_relative_rank: -0.0008
- v5 beats adaptive_relative_rank: no
- v5 margin over adaptive_learned_branch_score_v4: 0.0032
- v5 beats adaptive_learned_branch_score_v4: yes
- v6 margin over adaptive_relative_rank: 0.0156
