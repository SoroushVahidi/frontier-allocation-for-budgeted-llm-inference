...
### external_only
- `gold_absent_cb|overlay_cb` — **14**
- `overlay_cb` — **2**
- `code_absent_cb|discovery3_cb|exec_fail_cb|gold_absent_cb|parse_fail_cb|present_not_selected_cb|retry_ran_raw|retry_selected_raw|safety_fail_cb` — **1**
- `code_absent_cb|discovery3_cb|exec_fail_cb|gold_absent_cb|parse_fail_cb|retry_ran_raw|safety_fail_cb` — **1**
- `code_absent_cb|exec_fail_cb|gold_absent_cb|parse_fail_cb|retry_ran_raw|safety_fail_cb` — **1**
- `discovery3_cb|exec_fail_cb|gold_absent_cb|retry_ran_raw` — **1**
- `gold_absent_cb` — **1**

### both_wrong
- `gold_absent_cb|overlay_cb` — **21**
- `code_absent_cb|discovery3_cb|exec_fail_cb|gold_absent_cb|overlay_cb|parse_fail_cb|retry_ran_raw|retry_selected_raw|safety_fail_cb` — **2**
- `present_not_selected_cb` — **1**
- `exec_fail_cb|gold_absent_cb|retry_ran_raw|safety_fail_cb` — **1**
- `discovery3_cb|exec_fail_cb|gold_absent_cb|overlay_cb|retry_ran_raw|retry_selected_raw|safety_fail_cb` — **1**
- `overlay_cb` — **1**
