...
Repository identifiers are retained in the algorithm (Algorithm~\ref{alg:fix24}) and the name-mapping table (Table~\ref{tab:name_mapping}) for reproducibility.
...
Table~\ref{tab:name_mapping} provides the paper-facing to repository-name mapping.
