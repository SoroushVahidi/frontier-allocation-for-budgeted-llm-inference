...
The External-Consensus Fallback (FIX-4) targets a different pattern: when the
...
promotion-grade aggregate evidence or a robust policy improvement and was therefore
not promoted.
...
records and frontier trace metadata needed to replay FIX-2+FIX-4 under the current
protocol.
