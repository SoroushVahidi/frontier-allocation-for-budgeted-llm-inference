...
I will disclose the related conference manuscript under review for transparency. That manuscript addresses a broader frontier-search allocation formulation with tree-search policy controls and compute-budget surface analysis. The current MLJ manuscript focuses on Failure-Trace Allocator (FTA), GSM8K Final-300 and Aggregate-720, L1 / S1 / TALE comparisons, source-stratified bootstrap confidence intervals, and runtime-legal no-gold triggers.
