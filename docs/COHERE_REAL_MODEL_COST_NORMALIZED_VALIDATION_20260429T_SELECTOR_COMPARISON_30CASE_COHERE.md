...
- Timestamp: `20260429T_SELECTOR_COMPARISON_30CASE_COHERE`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260429T_SELECTOR_COMPARISON_30CASE_COHERE --resume --max-examples 30 --target-scored-per-slice 30`
- Providers: `['cohere']`
...
## Main accuracy table
- provider=cohere method=direct_reserve_semantic_frontier_v2: mean_accuracy=0.6667, total_scored=30
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: mean_accuracy=0.5667, total_scored=30
...
- provider=cohere method=direct_reserve_semantic_frontier_v2_selection_fix_v1: mean_accuracy=0.6333, total_scored=30
- provider=cohere method=external_l1_max: mean_accuracy=0.8000, total_scored=30

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2: total_tokens=31222, estimated_total_cost_usd=0.162282
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: total_tokens=30412, estimated_total_cost_usd=0.155124
- provider=cohere method=direct_reserve_semantic_frontier_v2_prm_step_verifier_rerank_v1: total_tokens=31599, estimated_total_cost_usd=0.166833
- provider=cohere method=direct_reserve_semantic_frontier_v2_selection_fix_v1: total_tokens=32389, estimated_total_cost_usd=0.168711
- provider=cohere method=external_l1_max: total_tokens=13907, estimated_total_cost_usd=0.074901
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260429T_SELECTOR_COMPARISON_30CASE_COHERE/`
