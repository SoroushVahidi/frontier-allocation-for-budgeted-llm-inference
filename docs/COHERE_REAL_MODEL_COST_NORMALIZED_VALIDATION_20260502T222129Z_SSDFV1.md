...
- Timestamp: `20260502T222129Z_SSDFV1`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260502T222129Z_SSDFV1 --resume --max-examples 128 --target-scored-per-slice 128`
- Providers: `['cohere']`
- Provider models: `{'cohere': 'command-r-plus-08-2024', 'openai': 'gpt-4o-mini'}`
- Datasets: `['openai/gsm8k']`
- Budgets: `[6, 8]`
- Seeds: `[11, 23, 37, 41, 53, 67]`
- Methods: `['strategy_seeded_semantic_diversity_frontier_v1']`
- Sample-size target per slice: `128` (max-examples cap `128`)
...
- Per-method completion counts:
  - strategy_seeded_semantic_diversity_frontier_v1: 0/12
...
## Main accuracy table
- provider=cohere method=strategy_seeded_semantic_diversity_frontier_v1: mean_accuracy=0.4934, total_scored=66

## Token/latency/cost table
- provider=cohere method=strategy_seeded_semantic_diversity_frontier_v1: total_tokens=153633, estimated_total_cost_usd=0.736755
...
- Is the evidence still appendix-only, or strong enough for main-paper use? **no_appendix_only** (incomplete_slices=12, mixed=False)
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260502T222129Z_SSDFV1/`
