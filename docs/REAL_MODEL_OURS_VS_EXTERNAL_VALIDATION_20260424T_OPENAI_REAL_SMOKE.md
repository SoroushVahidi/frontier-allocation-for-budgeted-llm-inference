...
Timestamp: `20260424T_OPENAI_REAL_SMOKE`.
Artifact package: `outputs/real_model_ours_vs_external_validation_20260424T_OPENAI_REAL_SMOKE/`.
...
- Seeds: [11]
- Budgets: [4, 8]
- Methods requested: ['strict_f3', 'strict_gate1_cap_k6', 'external_l1_max', 'self_consistency_3']
- Methods runnable: ['strict_f3', 'strict_gate1_cap_k6', 'external_l1_max', 'self_consistency_3']
- Unsupported in current canonical runner: []

## Required headline answers
1. Did best ours beat best external overall? NO
2. Best ours method: strict_f3 (0.5333)
3. Best external method: self_consistency_3 (0.5667)
4. Ours-minus-external gap: -0.0333
