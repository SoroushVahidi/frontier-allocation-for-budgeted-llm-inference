...
- Timestamp: `20260430T204800Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260430T204800Z --resume --max-examples 3 --target-scored-per-slice 3`
- Providers: `['cohere']`
...
- provider=cohere method=external_l1_max: mean_accuracy=0.6667, total_scored=3

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2: total_tokens=2892, estimated_total_cost_usd=0.015600
- provider=cohere method=external_l1_max: total_tokens=1388, estimated_total_cost_usd=0.007560
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260430T204800Z/`
