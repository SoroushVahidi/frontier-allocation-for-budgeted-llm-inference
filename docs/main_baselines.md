...
- **when_solve_when_verify:** v1 `official` + `import_validated` via `scripts/verify_when_solve_when_verify_import.py` (fixed-budget solve-vs-verify adjacent slices only; not frontier-allocation direct).
