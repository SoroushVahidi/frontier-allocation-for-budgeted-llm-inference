...
- Timestamp: `20260429T_THRESHOLDED_ORDERED_FIX_CHECK`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260429T_THRESHOLDED_ORDERED_FIX_CHECK --resume --max-examples 10 --target-scored-per-slice 10`
- Providers: `['cohere']`
...
- provider=cohere method=external_l1_max: mean_accuracy=1.0000, total_scored=10

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2: total_tokens=10597, estimated_total_cost_usd=0.054915
- provider=cohere method=external_l1_max: total_tokens=4791, estimated_total_cost_usd=0.026865
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260429T_THRESHOLDED_ORDERED_FIX_CHECK/`
