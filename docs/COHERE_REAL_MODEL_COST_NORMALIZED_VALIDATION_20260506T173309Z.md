...
- Timestamp: `20260506T173309Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260506T173309Z --resume --max-examples 5 --target-scored-per-slice 5`
- Providers: `['cohere']`
...
## Main accuracy table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: mean_accuracy=0.6000, total_scored=5

## Token/latency/cost table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: total_tokens=18199, estimated_total_cost_usd=0.081417
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260506T173309Z/`
