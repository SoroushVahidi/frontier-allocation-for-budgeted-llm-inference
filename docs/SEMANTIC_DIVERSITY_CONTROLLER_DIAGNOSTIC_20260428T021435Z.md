# Semantic diversity controller diagnostic (20260428T021435Z)
...
- **Loss / selected cases evaluated (unique example_ids in manifest):** (see per_case_results.csv)
- **Per-method rows in per_case_results.csv:** 0

## Headline comparisons

- **Accuracy summary:** (missing method_accuracy_summary.csv)

### vs strict_f3

- **Paired rows with delta > 0 vs strict_f3:** 0 (non-experimental methods excluded from paired_summary)
- **Any experimental method beat strict_f3 on at least one paired row:** no

### vs external_l1_max

- **Paired deltas ≥ 0 vs external_l1_max:** 0 rows with numeric delta
- **Paired deltas > 0 vs external_l1_max:** 0
...
- **Dominant category:** (empty failure_taxonomy.csv)

### Token / latency / cost proxy

- **Rows in token_cost_latency_summary.csv:** 0

## Artifacts

- Output directory: `outputs/semantic_diversity_controller_diagnostic_20260428T021435Z`
