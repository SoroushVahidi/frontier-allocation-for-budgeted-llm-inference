...
- `self_consistency_3` accuracy=0.6500, absent_from_tree_rate=0.3500, output_layer_mismatch_rate=0.0000
- `strict_f3` accuracy=0.6500, absent_from_tree_rate=0.3500, output_layer_mismatch_rate=0.0000
- `external_l1_max` accuracy=0.6000, absent_from_tree_rate=0.4000, output_layer_mismatch_rate=0.0000
- `strict_f2` accuracy=0.5000, absent_from_tree_rate=0.5000, output_layer_mismatch_rate=0.0000
- `strict_gate1_cap_k6` accuracy=0.4500, absent_from_tree_rate=0.5500, output_layer_mismatch_rate=0.0000
