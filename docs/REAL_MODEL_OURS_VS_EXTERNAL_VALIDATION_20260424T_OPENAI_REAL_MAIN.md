...
Artifact package: `outputs/real_model_ours_vs_external_validation_20260424T_OPENAI_REAL_MAIN/`.

## Contract used
- Providers requested: ['openai']
- Datasets active: ['openai/gsm8k', 'HuggingFaceH4/MATH-500', 'HuggingFaceH4/aime_2024']
- Subset size: 20
- Seeds: [11, 23]
- Budgets: [4, 6, 8]
- Methods requested: ['strict_f3', 'strict_gate1_cap_k6', 'strict_f2', 'external_l1_max', 'external_l1_exact', 'external_tale_prompt_budgeting', 'external_s1_budget_forcing', 'self_consistency_3']
- Methods runnable: ['strict_f3', 'strict_gate1_cap_k6', 'strict_f2', 'external_l1_max', 'self_consistency_3']
- Unsupported in current canonical runner: ['external_l1_exact', 'external_tale_prompt_budgeting', 'external_s1_budget_forcing']

## Required headline answers
1. Did best ours beat best external overall? NO
2. Best ours method: strict_f3 (0.4833)
3. Best external method: external_l1_max (0.5417)
4. Ours-minus-external gap: -0.0583
...
7. API/runtime errors: 1 row(s) in `openai/retry_error_log.csv`.
