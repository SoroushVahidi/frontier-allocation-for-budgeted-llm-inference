...
- Timestamp: `20260502T004638Z_ov`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260502T004638Z_ov --resume --max-examples 0 --target-scored-per-slice 100`
- Providers: `['cohere']`
...
## Main accuracy table
- provider=cohere method=direct_reserve_semantic_frontier_v2: mean_accuracy=0.6900, total_scored=100
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: mean_accuracy=0.6700, total_scored=100
- provider=cohere method=external_l1_max: mean_accuracy=0.7600, total_scored=100

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2: total_tokens=342722, estimated_total_cost_usd=1.373274
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: total_tokens=341255, estimated_total_cost_usd=1.368549
- provider=cohere method=external_l1_max: total_tokens=284573, estimated_total_cost_usd=1.152303
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260502T004638Z_ov/`
