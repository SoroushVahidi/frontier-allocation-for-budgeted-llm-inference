...
- Timestamp: `20260506T130225Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260506T130225Z --resume --max-examples 246 --target-scored-per-slice 246`
- Providers: `['cohere']`
...
- Sample-size target per slice: `246` (max-examples cap `246`)
...
## Main accuracy table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: mean_accuracy=0.8931, total_scored=131
- provider=cohere method=external_l1_max: mean_accuracy=0.8415, total_scored=246

## Token/latency/cost table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: total_tokens=350077, estimated_total_cost_usd=1.440483
- provider=cohere method=external_l1_max: total_tokens=669699, estimated_total_cost_usd=2.605773
