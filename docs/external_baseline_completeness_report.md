...
- Generated (UTC): `2026-04-20T22:58:50.745974+00:00`
...
| BEST-Route (`best_route_microsoft`) | runnable_adjacent | import_validated | not_applicable | adjacent | not_applicable | adjacent | yes_verified_import | adjacent_import_validator | not_applicable |
...
| When To Solve, When To Verify (`when_solve_when_verify`) | runnable_adjacent | import_validated | not_applicable | adjacent | not_applicable | adjacent | yes_verified_import | adjacent_import_validator | not_applicable |
