...
- Timestamp: `20260506T194114Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260506T194114Z --resume --max-examples 300 --target-scored-per-slice 300`
- Providers: `['cohere']`
...
- Sample-size target per slice: `300` (max-examples cap `300`)
...
## Main accuracy table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: mean_accuracy=0.8400, total_scored=300
- provider=cohere method=external_l1_max: mean_accuracy=0.8133, total_scored=300

## Token/latency/cost table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: total_tokens=823172, estimated_total_cost_usd=3.384084
- provider=cohere method=external_l1_max: total_tokens=849485, estimated_total_cost_usd=3.306675
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260506T194114Z/`
