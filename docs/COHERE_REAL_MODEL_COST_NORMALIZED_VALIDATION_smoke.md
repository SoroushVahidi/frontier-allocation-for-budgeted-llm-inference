...
- Timestamp: `smoke`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp smoke --resume --max-examples 3 --target-scored-per-slice 3`
- Providers: `['cohere']`
...
- provider=cohere method=external_l1_max: mean_accuracy=0.0000, total_scored=3

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2: total_tokens=2904, estimated_total_cost_usd=0.015780
- provider=cohere method=external_l1_max: total_tokens=1348, estimated_total_cost_usd=0.006960
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_smoke/`
