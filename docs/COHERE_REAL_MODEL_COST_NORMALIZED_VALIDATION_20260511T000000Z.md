...
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260511T000000Z --resume --max-examples 0 --target-scored-per-slice 100`
- Providers: `['cohere']`
...
- Per-method completion counts:
  - target_staged_pal_frontier_v1: 0/6
...
## Main accuracy table
- provider=cohere method=target_staged_pal_frontier_v1: mean_accuracy=0.2583, total_scored=23

## Token/latency/cost table
- provider=cohere method=target_staged_pal_frontier_v1: total_tokens=27339, estimated_total_cost_usd=0.120453
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260511T000000Z/`
