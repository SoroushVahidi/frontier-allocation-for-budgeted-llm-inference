...
- Subset size per dataset per seed: 1
- Seeds: [11]
- Budgets: [4]
- Methods: ['strict_f3', 'strict_gate1_cap_k6', 'self_consistency_3', 'external_l1_max', 'strict_f3_no_anti_collapse', 'strict_f3_no_repeat_expansion_control', 'strict_f3_no_output_repair']
...
- `external_l1_max` accuracy=0.6667, absent_from_tree_rate=0.3333, output_layer_mismatch_rate=0.0000
- `strict_f3` accuracy=0.6667, absent_from_tree_rate=0.3333, output_layer_mismatch_rate=0.0000
- `strict_f3_no_anti_collapse` accuracy=0.6667, absent_from_tree_rate=0.3333, output_layer_mismatch_rate=0.0000
- `strict_f3_no_repeat_expansion_control` accuracy=0.6667, absent_from_tree_rate=0.3333, output_layer_mismatch_rate=0.0000
- `self_consistency_3` accuracy=0.3333, absent_from_tree_rate=0.6667, output_layer_mismatch_rate=0.0000
- `strict_f3_no_output_repair` accuracy=0.3333, absent_from_tree_rate=0.6667, output_layer_mismatch_rate=0.0000
- `strict_gate1_cap_k6` accuracy=0.0000, absent_from_tree_rate=1.0000, output_layer_mismatch_rate=0.0000
- Repair delta (strict_f3): +0.3333 (with_repair=0.6667, without=0.3333)
...
## Artifact directory
- `outputs/canonical_real_model_validation_20260423T121500Z/`
