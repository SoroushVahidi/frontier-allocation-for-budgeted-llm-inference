...
- `external_l1_max` accuracy=0.2000, absent_from_tree_rate=0.8000, output_layer_mismatch_rate=0.0000
- `strict_f2` accuracy=0.1500, absent_from_tree_rate=0.8500, output_layer_mismatch_rate=0.0000
- `strict_f3` accuracy=0.1500, absent_from_tree_rate=0.8500, output_layer_mismatch_rate=0.0000
- `strict_gate1_cap_k6` accuracy=0.0500, absent_from_tree_rate=0.9500, output_layer_mismatch_rate=0.0000
