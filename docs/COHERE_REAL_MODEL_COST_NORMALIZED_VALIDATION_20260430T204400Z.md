...
- Timestamp: `20260430T204400Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260430T204400Z --resume --max-examples 3 --target-scored-per-slice 3`
- Providers: `['cohere']`
...
## Main accuracy table
- provider=cohere method=direct_reserve_semantic_frontier_v2: mean_accuracy=0.6667, total_scored=3
- provider=cohere method=external_l1_max: mean_accuracy=1.0000, total_scored=3

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2: total_tokens=2981, estimated_total_cost_usd=0.016935
- provider=cohere method=external_l1_max: total_tokens=1387, estimated_total_cost_usd=0.007545
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260430T204400Z/`
