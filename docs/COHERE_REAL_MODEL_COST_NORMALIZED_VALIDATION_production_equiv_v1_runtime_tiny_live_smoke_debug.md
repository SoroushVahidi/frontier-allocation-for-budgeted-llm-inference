...
- Timestamp: `production_equiv_v1_runtime_tiny_live_smoke_debug`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp production_equiv_v1_runtime_tiny_live_smoke_debug --resume --max-examples 3 --target-scored-per-slice 3`
- Providers: `['cohere']`
