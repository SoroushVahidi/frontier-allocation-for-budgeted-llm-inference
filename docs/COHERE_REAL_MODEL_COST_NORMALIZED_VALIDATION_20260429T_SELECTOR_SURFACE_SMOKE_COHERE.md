...
- Timestamp: `20260429T_SELECTOR_SURFACE_SMOKE_COHERE`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260429T_SELECTOR_SURFACE_SMOKE_COHERE --resume --max-examples 3 --target-scored-per-slice 3`
- Providers: `['cohere']`
...
## Main accuracy table
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: mean_accuracy=0.6667, total_scored=3
- provider=cohere method=direct_reserve_semantic_frontier_v2_prm_step_verifier_rerank_v1: mean_accuracy=1.0000, total_scored=3

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: total_tokens=2982, estimated_total_cost_usd=0.016950
- provider=cohere method=direct_reserve_semantic_frontier_v2_prm_step_verifier_rerank_v1: total_tokens=2950, estimated_total_cost_usd=0.016470
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260429T_SELECTOR_SURFACE_SMOKE_COHERE/`
