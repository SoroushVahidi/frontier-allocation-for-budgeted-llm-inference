...
- Timestamp: `20260506T151731Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260506T151731Z --resume --max-examples 150 --target-scored-per-slice 150`
- Providers: `['cohere']`
...
- Sample-size target per slice: `150` (max-examples cap `150`)
...
## Main accuracy table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: mean_accuracy=0.8800, total_scored=150
- provider=cohere method=external_l1_max: mean_accuracy=0.8333, total_scored=150

## Token/latency/cost table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: total_tokens=402574, estimated_total_cost_usd=1.656654
- provider=cohere method=external_l1_max: total_tokens=391997, estimated_total_cost_usd=1.526979
