...
- `external_l1_max` accuracy=0.2500, absent_from_tree_rate=0.7500, output_layer_mismatch_rate=0.0000
- `self_consistency_3` accuracy=0.2500, absent_from_tree_rate=0.7500, output_layer_mismatch_rate=0.0000
- `strict_f2` accuracy=0.2500, absent_from_tree_rate=0.7500, output_layer_mismatch_rate=0.0000
- `strict_f3` accuracy=0.2500, absent_from_tree_rate=0.7500, output_layer_mismatch_rate=0.0000
- `strict_gate1_cap_k6` accuracy=0.2000, absent_from_tree_rate=0.7500, output_layer_mismatch_rate=0.0000
...
## Artifact directory
- `outputs/canonical_real_model_validation_20260424T_COHERE_REAL_MAIN_PATCH_20260424T163922Z_cohere_23_8_HuggingFaceH4_MATH-500/`
