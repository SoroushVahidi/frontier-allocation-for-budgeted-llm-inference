# SHALLOW_EXHAUSTIVE_PROBE_REPORT_20260425T_SHALLOW_PROBE_FULL_DRYRUN

- Output directory: `outputs/shallow_exhaustive_probe_20260425T_SHALLOW_PROBE_FULL_DRYRUN/`
- Dataset slice: strict_f3-loss cases where external_l1_max was correct (n=150).
- Mode: `dry-run (offline)`

## Explicit answers
1. Did exhaustive depth-2 exploration reduce absent-from-tree failures? **No or neutral** (delta=-0.0667).
2. Did exhaustive depth-3 exploration reduce absent-from-tree failures? **No or neutral** (delta=-0.0533).
3. Did the correct answer usually appear shallowly once breadth was forced, or remain absent?
   - Depth-2 first-appearance-after-forced-depth2 share: 0.0467
   - Depth-3 first-appearance-after-forced-depth3 share: 0.0133
