...
- Exploratory early answer-diversity maturation variants (`early_answer_diversity_maturation_v1`, `early_answer_diversity_maturation_gated_v1`) were tested as provenance-only diagnostics and should not be promoted: both underperform `strict_f3` on the audited simulation slice and do not reduce absent-from-tree failures.
