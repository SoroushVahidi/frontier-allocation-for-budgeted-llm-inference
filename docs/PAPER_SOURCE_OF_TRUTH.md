...
- `outputs/held_out_surface_generalization_claim_safety_20260424T231500Z_DRY/` (held-out-surface dry-run package with required outputs and conservative claim-safety table)
