...
- Timestamp: `20260501T023500Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260501T023500Z --resume --max-examples 1 --target-scored-per-slice 1`
- Providers: `['cohere']`
...
- Sample-size target per slice: `1` (max-examples cap `1`)
...
## Main accuracy table
- provider=cohere method=direct_reserve_semantic_frontier_v2: mean_accuracy=1.0000, total_scored=1
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: mean_accuracy=1.0000, total_scored=1
- provider=cohere method=external_l1_max: mean_accuracy=1.0000, total_scored=1

## Token/latency/cost table
- provider=cohere method=direct_reserve_semantic_frontier_v2: total_tokens=3202, estimated_total_cost_usd=0.012462
- provider=cohere method=direct_reserve_semantic_frontier_v2_outcome_verifier_rerank_v1: total_tokens=3203, estimated_total_cost_usd=0.012513
- provider=cohere method=external_l1_max: total_tokens=1567, estimated_total_cost_usd=0.006141
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260501T023500Z/`
