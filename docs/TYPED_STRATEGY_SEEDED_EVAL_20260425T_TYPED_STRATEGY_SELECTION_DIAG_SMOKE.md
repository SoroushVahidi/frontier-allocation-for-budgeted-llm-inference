# TYPED_STRATEGY_SEEDED_EVAL_20260425T_TYPED_STRATEGY_SELECTION_DIAG_SMOKE

1. Did typed strategy seeding reduce absent-from-tree failures on the 150 loss cases? yes.
...
9. Did typed seeding increase actions/cost/latency? avg_actions strict_f3=3.900, typed=4.000.
