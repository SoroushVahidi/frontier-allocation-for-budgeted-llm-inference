...
- Timestamp: `20260507T152735Z`
- Exact command: `python scripts/run_cohere_real_model_cost_normalized_validation.py --timestamp 20260507T152735Z --resume --max-examples 30 --target-scored-per-slice 30`
- Providers: `['cohere']`
...
## Main accuracy table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: mean_accuracy=0.5667, total_scored=30
- provider=cohere method=external_l1_max: mean_accuracy=0.7000, total_scored=30
- provider=cohere method=external_s1_budget_forcing: mean_accuracy=0.6667, total_scored=30
- provider=cohere method=external_tale_prompt_budgeting: mean_accuracy=0.6667, total_scored=30

## Token/latency/cost table
- provider=cohere method=direct_reserve_diverse_root_frontier_v1_guarded_k1_frontier4_frontier_tiebreak_pal: total_tokens=33941, estimated_total_cost_usd=0.146379
- provider=cohere method=external_l1_max: total_tokens=21316, estimated_total_cost_usd=0.109332
- provider=cohere method=external_s1_budget_forcing: total_tokens=36571, estimated_total_cost_usd=0.169905
- provider=cohere method=external_tale_prompt_budgeting: total_tokens=24725, estimated_total_cost_usd=0.123567
...
## Artifact directory
- `outputs/cohere_real_model_cost_normalized_validation_20260507T152735Z/`
