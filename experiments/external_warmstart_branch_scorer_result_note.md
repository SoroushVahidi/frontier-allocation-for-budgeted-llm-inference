...
- Run dir: `outputs/new_paper/external_warmstart_branch_scorer/20260414T131041Z`
- Key outcomes:
...
- Next default direction: keep internal supervision central and use external datasets as a warm-start regularizer / initialization path.
