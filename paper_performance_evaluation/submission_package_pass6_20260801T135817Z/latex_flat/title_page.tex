...
% TODO(author-confirmation): Confirm final affiliation, email, and ORCID before journal upload.
\author[aff1]{Soroush Vahidi\corref{cor1}\fnref{fn1}}
\ead{[AUTHOR CONFIRMATION REQUIRED: corresponding author email]}

% TODO(author-confirmation): ORCID and phone are journal/system-dependent fields.
\cortext[cor1]{Corresponding author}
\fntext[fn1]{ORCID: [AUTHOR CONFIRMATION REQUIRED]}

\address[aff1]{[AUTHOR CONFIRMATION REQUIRED: Department, Institution, City, Country]}
