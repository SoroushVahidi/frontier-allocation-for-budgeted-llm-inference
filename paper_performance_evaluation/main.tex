...
deterministic verification of the reported tables and numerical invariants for all 15 completed
...
may incur API charges. The manifests define the public replay boundary for the reported analyses.
