...
tables, producing scripts, and package checksums for the Azure true-SC comparison, held-out selector,
and 15-cell matrix summaries. The public artifacts support deterministic verification of the
