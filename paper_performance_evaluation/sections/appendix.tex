...
\input{tables/table7_historical_component_ablation}
\end{table}
...
\resizebox{\textwidth}{!}{\input{tables/table8_non_math_pilot}}
\end{table}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.78\linewidth]{figures/figure3_search_vs_selection_scatter}
