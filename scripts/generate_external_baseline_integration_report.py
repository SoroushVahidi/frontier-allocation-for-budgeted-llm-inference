...
LEGACY: list[dict[str, str | bool]] = [
    ...
    },
    {
        ...
        "paper_link": "https://aclanthology.org/2024.emnlp-main.125/",
        "official_code_link": "https://github.com/Hareta-Leila/Tree-PLV",
        "license_status": "No root LICENSE file visible in audited snapshot (treat conservatively)",
        "could_add_to_repository": "YES_PARTIAL",
        "integration_status": "IMPORT_VALIDATED_ADJACENT_PARTIAL_RUNNABLE",
        "what_was_added": "external/tree_plv/README.md; docs/tree_plv_integration.md; contract/validator/runner/status scripts",
        "what_is_still_missing": "Full benchmark-faithful reproduction path and checkpoint-backed replication evidence",
        "recommended_for_main_paper_now": True,
        "reason": "Official paper + paper-cited repo now support a conservative partial-runnable adjacent lane.",
    },
    {
        "baseline_name": "pgts",
