#!/usr/bin/env python3
"""Verify L1 MODE B official/full import package against strict contract."""
...
MODE_A_METHOD_MARKERS = {"adaptive_min_expand_1", "external_l1_exact", "external_l1_max"}
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Verify L1 MODE B import package")
