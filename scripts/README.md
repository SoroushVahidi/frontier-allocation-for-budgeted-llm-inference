...
### 4. Run the current adjacent external baseline integration stack
...
- The current highest-leverage paper-facing external scripts are the MODE A `s1` / `TALE` / `L1` runners plus the adjacent BEST-Route / solve-verify / ReST-MCTS integration lanes.
