...
def main() -> None:
    ...
    summary = {
        ...
        "single_next_priority": "rest_mcts",
        "single_next_priority_rationale": "After unblocking BEST-Route, when_solve_when_verify, cascade_routing, and MoB via adjacent validators, ReST-MCTS remains the next high-priority link-only baseline."
    }
