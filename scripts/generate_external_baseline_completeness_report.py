...
CLASSIFICATION_ROWS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "blocker": "Upstream BEST-Route pipeline depends on mixed multi-dataset response banks, ArmoRM scoring, and router training stack not mapped to this repo's frontier/action substrate.",
        "next_requirement": "Design a fair adapter protocol on shared prompts/models with matched cost accounting and a common reward/scoring interface.",
    },
    {
    ...
    },
    {
        ...
        "mode_a": "not_applicable",
        "mode_b": "not_applicable",
        "blocker": "No in-repo adapter; upstream stack not normalized to this repo's evaluation substrate.",
        "next_requirement": "Define shared dataset/cost protocol and minimal import adapter.",
    },
    {
...
def main() -> None:
    ...
    summary = {
        ...
        "single_next_priority": "when_solve_when_verify",
        "single_next_priority_rationale": "After compute_optimal_tts blocker/provenance protocol is in place, solve-vs-verify is the next adjacent budget-allocation baseline to harden.",
    }
