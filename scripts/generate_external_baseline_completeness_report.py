...
CLASSIFICATION_ROWS: list[dict[str, str]] = [
    ...
    {
        "baseline_key": "conformal_thinking",
        "display_name": "Conformal Thinking",
        ...
        "blocker": "Primary arXiv sources verified; official public code is not clearly verified.",
        "next_requirement": "Verify official public code provenance before any official reproduction claim.",
    },
    {
        "baseline_key": "conformal_thinking_mode_a",
        "display_name": "Conformal Thinking MODE A",
        "category": "adapter_based",
        "status_v1_mode_a": "adapter_based",
        "status_v1_mode_b": "not_applicable",
        "control_v1_mode_a": "adjacent",
        "control_v1_mode_b": "not_applicable",
        ...
        "mode_a": "runnable",
        "mode_b": "not_applicable",
        "blocker": "Paper-inspired matched-substrate adapter only; not an official reproduction.",
        "next_requirement": "Run and audit diagnostics before any manuscript-facing table promotion.",
    },
    {
