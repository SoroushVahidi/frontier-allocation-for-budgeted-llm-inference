...
# Pick strongest learned scorer from job 914308 controller-eval outputs.
...
if not any(scores.values()):
    # Conservative fallback if selection files do not exist yet.
...
# Held-out canonical regimes for manuscript-facing final evaluation.
...
# Budget sweep table for figure-ready plotting.
