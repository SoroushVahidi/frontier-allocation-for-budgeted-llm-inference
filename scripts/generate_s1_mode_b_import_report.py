#!/usr/bin/env python3
"""Generate markdown report from s1 MODE B import verification JSON."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Generate s1 MODE B import report")
...
def main() -> None:
    ...
    if status == "valid":
        lines.extend(
            [
                "- Import accepted.",
                "- Schema, metadata completeness, provenance fields, and fairness protocol checks passed.",
