            ...
            per_case_method_results.append(
                {
                    ...
                    "learned_override_available": int(bool(metadata.get("learned_override_available", False))),
                    "learned_override_triggered": int(bool(metadata.get("learned_override_triggered", False))),
                    "learned_override_model": metadata.get("learned_override_model", "NA"),
                    "learned_override_margin": metadata.get("learned_override_margin", "NA"),
                    "learned_override_threshold": metadata.get("learned_override_threshold", "NA"),
                    "base_selected_answer": metadata.get("base_selected_answer", "NA"),
                    "learned_selected_answer": metadata.get("learned_selected_answer", "NA"),
                    "final_selected_answer_after_learned_override": metadata.get("final_selected_answer", selected_norm),
                    "learned_override_reason": metadata.get("learned_override_reason", "NA"),
                    "learned_override_missing_features": ",".join(metadata.get("learned_override_missing_features", []) or []),
                    "candidate_feature_schema_version": metadata.get("candidate_feature_schema_version", "NA"),
                    "candidate_count": metadata.get("candidate_count", "NA"),
                    "learned_answer_group_count": metadata.get("answer_group_count", "NA"),
