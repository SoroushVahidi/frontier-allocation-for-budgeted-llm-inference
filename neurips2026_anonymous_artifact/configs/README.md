...
| [`dataset_experiment_readiness_bundles.json`](dataset_experiment_readiness_bundles.json) | Lightweight dataset bundles for readiness-era experiment invocation (exact-answer math expansion, MCQ breadth control, codegen partial). |
