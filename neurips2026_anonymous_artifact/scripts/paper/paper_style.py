...
METHOD_COLORS = {
    # Manuscript-facing methods and near-direct externals.
    "strict_f3": "#1b9e77",
    ...
    "external_l1_exact": "#6a3d9a",
    "external_tale_prompt_budgeting": "#a65628",
    "external_s1_budget_forcing": "#e41a1c",
    # Canonical-name aliases used in some table/legacy contexts.
    "strict_gate1_cap_k6 (default)": "#377eb8",
    "baseline": "#666666",
    "fixed_k6": "#1b9e77",
    "min6_half": "#66a61e",
    "min6_third": "#377eb8",
