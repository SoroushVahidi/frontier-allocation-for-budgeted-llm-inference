...
def main() -> None:
    ...
    p.add_argument("--input", default=str(PLOT_DATA_DIR / "anti_collapse_diagnostics.csv"))
    ...
    for method in grouped_methods(rows):
        ...
        ax.plot(
            ...
            [float(r["max_family_share"]) for r in mrows],
            marker="o",
            label=method,
        )

    style_ax(ax, "Anti-Collapse Diagnostic: Max Family Share", "Budget", "Max Action Family Share")
