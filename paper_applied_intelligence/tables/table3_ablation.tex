...
Low-Depth Guard (LDG, implementation: FIX-2) low-depth guard & single-weak-frontier-branch / low depth & 80.00\% & no (superseded by Failure-Trace Allocator (FTA, implementation: FIX-2+FIX-4)) \\
...
\textbf{Failure-Trace Allocator (FTA, implementation: FIX-2+FIX-4)} & low-depth + external-consensus & final300=86.67\%; agg720=80.69\% & \textbf{yes} \\
