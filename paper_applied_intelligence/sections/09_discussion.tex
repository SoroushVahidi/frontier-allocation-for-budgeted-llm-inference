...
As supporting evidence for the generality of the failure-trace signal,
...
These results are consistent with the hypothesis that frontier structural
weakness is a provider-independent signal, but the evaluation scope is
preliminary (80--160 examples per provider); the findings constitute
supporting evidence, not a second primary claim.
