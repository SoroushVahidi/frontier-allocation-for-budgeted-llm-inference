...
answer.
The External-Consensus Fallback (ECO) identifies cases where all three
external baselines unanimously disagree with the frontier's selection,
overriding to the consensus answer.
