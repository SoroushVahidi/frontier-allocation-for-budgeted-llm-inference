...
def test_hard_max_family_cap_variants_registered() -> None:
    ...
    assert f"{BASE}_hard_early_root_depth2_then_gate_v1_optimistic_collapse_first_hard_max_family_expansions_cap_k7_v1" in specs
    assert f"{BASE}_hard_early_root_depth2_then_gate_v1_optimistic_collapse_first_hard_max_family_expansions_cap_k8_v1" in specs
