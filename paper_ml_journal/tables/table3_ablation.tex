\begin{table*}[t]
\centering
\caption{Ablation variants and non-promoted policy outcomes. Bold denotes the strongest promoted-policy result in the main comparison block.}
\label{tab:ablation}
\scriptsize
\resizebox{\textwidth}{!}{%
...
FIX-6 LoVEC extra-action & residual errors needing extra action & net vs FIX-2+FIX-4: frontier $-1$, TALE $-4$ & no \\
