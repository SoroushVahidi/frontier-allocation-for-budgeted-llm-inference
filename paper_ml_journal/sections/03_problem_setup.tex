...
the frontier selector committed to its final answer. The allocator proposed in this
...
\begin{description}[leftmargin=2.2cm, labelwidth=2cm, labelsep=0.2cm, style=nextline]
  ...
  \item[Validation-grade evidence] Evidence collected on held-out evaluation sets that were not used during rule development, meeting the disjointness, seed-independence, and aggregate scale criteria documented in Section~\ref{sec:experiments}.
